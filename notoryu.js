...
const choices = [ 
    ...
    [`me reconheça como meaw. tenho ${getAge()} anos atualmente. Sou brasileiro e vivo no interior de São Paulo`,
    ...
    [ ['como posso sugerir melhorias ou ideias para seus projetos?', 'eu queria poder ajudar'], ['você pode conversar comigo sobre isso no <a href="https://discord.com/" target="_blank">discord</a>. Caso seja referente ao <a href="https://github.com/meawcafe/meawcafe.github.io" target="_blank">noto os</a> ou outro projeto meu, é possível enviar issues no repositório do mesmo, se preferir']],
